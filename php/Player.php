...
class Player extends BaseClass
{
    ...
    {
        $result = $mysql->execute("SELECT * FROM player WHERE id = " . $id);
        $row = $result->fetch_object("Player");
	...
	{
		$mySql->prepare("UPDATE player SET FirstName = ?, LastName = ?, TeamId = ? WHERE Id = ?", 
                        array("ssii", 
                              $this->FirstName, 
							  $this->LastName,
                              $this->TeamId,
	...
	{
	    $mySql->prepare("INSERT INTO player (FirstName, LastName, TeamId) VALUES (?, ?, ?)", 
                        array("ssi",
                              $this->FirstName, 
                              $this->LastName,
                              $this->TeamId));
